...
public class GameActivity extends AppCompatActivity {
    ...
    Runnable timerRunnable = new Runnable() {
        ...
        public void run() {
            ...
            if ((cantOportunidad > 0) && (contadorObjeto < totalMatches)) {
                ...
                ultimaPal = randomPos;
                palActual = (Palabra)palabraList.get(ultimaPal);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            ...
            palabraList = (ArrayList<Palabra>) extras.getSerializable("key");
    ...
    private void initGame(){
        ...
        palActual = (Palabra) palabraList.get(usado1);
        ...
        numeros.remove(randomPos);
        palActual = (Palabra)palabraList.get(usado2);
        palabrasArray.add(palActual.getName());
        ...
        numeros.remove(randomPos);
        palActual = (Palabra)palabraList.get(usado3);
        palabrasArray.add(palActual.getName());
